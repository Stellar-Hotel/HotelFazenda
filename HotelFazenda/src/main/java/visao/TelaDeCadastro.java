...
public class TelaDeCadastro extends JFrame {
	...
	public TelaDeCadastro() {
		...
		textField.setBounds(52, 209, 86, 20);
		...
		textField_1.setBounds(52, 337, 86, 20);
		contentPane.add(textField_1);
		textField_1.setColumns(10);
		
		JLabel lblNewLabel_4 = new JLabel("New label");
		lblNewLabel_4.setBounds(727, 299, 46, 14);
		contentPane.add(lblNewLabel_4);
		
		textField_2 = new JTextField();
		textField_2.setBounds(727, 337, 86, 20);
		...
		textField_3.setBounds(52, 474, 86, 20);
		contentPane.add(textField_3);
		textField_3.setColumns(10);
		
		JButton btnNewButton = new JButton("New button");
		btnNewButton.setBounds(496, 550, 90, 23);
