...
//	}
	...
	public TelaDeHospedes( ) {
		...
		contentPane.setLayout(new MigLayout("", "[200px:200px:200px][830.00,grow]",
				"[40px:49.00px:40px][469.00,grow,fill][60px:60px:60px]"));

		JPanel BarraLateral = new JPanel();
		BarraLateral.setBackground(new Color(255, 255, 255));
		contentPane.add(BarraLateral, "cell 0 1 1 2,grow");
		BarraLateral.setLayout(new MigLayout("", "[131px,grow]", "[20px:20px:20px][40px][40px][40px][40px][40px][40px][40px,baseline][40px][171px,grow][98.00]"));
		...
		lblNewLabel_19.setIcon(new ImageIcon(TelaDeHospedes.class.getResource("/visao/Quartos.jpg")));
		...
		BarraLateral.add(lblNewLabel_1, "flowx,cell 0 7");
		...
		BarraLateral.add(lblFuncionarios, "cell 0 7");
		...
		BarraLateral.add(lblNewLabel_2_1, "cell 0 8");
