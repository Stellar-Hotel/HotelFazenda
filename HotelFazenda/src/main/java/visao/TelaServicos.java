...
public class TelaServicos extends JFrame {
	...
	public TelaServicos() {
		...
		panel_8_2.setLayout(new MigLayout("", "[30:30:30,grow][65.00,grow,fill][90.00][27,grow][97.00][20,grow,fill][84.00][24,grow,fill][63.00][186.00,grow,left]", "[14px]"));
		...
		panel_8_2.add(lblNewLabel_25, "flowx,cell 9 0,alignx left");

		JLabel lblNewLabel_26 = new JLabel("0");
		panel_8_2.add(lblNewLabel_26, "cell 9 0,alignx left");

		JLabel lblNewLabel_27 = new JLabel("");
		lblNewLabel_27.setIcon(new ImageIcon(TelaServicos.class.getResource("/visao/Add_square_light.png")));
		panel_8_2.add(lblNewLabel_27, "cell 9 0,alignx left");

		JPanel panel_8_8 = new JPanel();
		Principal.add(panel_8_8, "cell 1 5 4 1,grow");
		panel_8_8.setLayout(new MigLayout("", "[30:30:30,grow][27,grow,fill][90.00][27,grow][97.00][20,grow,fill][84.00][24,grow,fill][63.00][186.00,grow,left]", "[14px]"));
		...
		panel_8_8.add(lblNewLabel_74, "flowx,cell 9 0,alignx left");

		JLabel lblNewLabel_75 = new JLabel("0");
		lblNewLabel_75.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		panel_8_8.add(lblNewLabel_75, "cell 9 0,alignx left");

		JLabel lblNewLabel_76 = new JLabel("");
		lblNewLabel_76.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblNewLabel_76.setIcon(new ImageIcon(TelaServicos.class.getResource("/visao/Add_square_light.png")));
		panel_8_8.add(lblNewLabel_76, "cell 9 0,alignx left");
		
		

		JPanel panel_8_1 = new JPanel();
		Principal.add(panel_8_1, "cell 1 7 4 1,grow");
		panel_8_1.setLayout(new MigLayout("", "[30:30:30,grow][27,grow,fill][102.00][27,grow][97.00][20,grow,fill][84.00][24,grow,fill][63.00][186.00,grow,left]", "[14px]"));
		...
		panel_8_1.add(lblNewLabel_18, "flowx,cell 9 0,alignx left");

		JLabel lblNewLabel_19 = new JLabel("0");
		lblNewLabel_19.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		panel_8_1.add(lblNewLabel_19, "cell 9 0,alignx left");
		...
		panel_8_1.add(lblNewLabel_20, "cell 9 0,alignx left");
		lblNewLabel_18.setIcon(new ImageIcon(TelaServicos.class.getResource("/visao/Group 8756.png")));
		lblNewLabel_19.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		lblNewLabel_20.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblNewLabel_20.setIcon(new ImageIcon(TelaServicos.class.getResource("/visao/Add_square_light.png")));
		...
		panel_8_4.setLayout(new MigLayout("", "[30:30:30,grow][27,grow,fill][119.00][27,grow][97.00][20,grow,fill][84.00][24,grow,fill][63.00][186.00,grow,left]", "[14px]"));
		...
		panel_8_4.add(lblNewLabel_42, "flowx,cell 9 0,alignx left");

		JLabel lblNewLabel_43 = new JLabel("0");
		lblNewLabel_43.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		panel_8_4.add(lblNewLabel_43, "cell 9 0,alignx left");
		...
		panel_8_4.add(lblNewLabel_44, "cell 9 0,alignx left");

		JPanel panel_8_3 = new JPanel();
		Principal.add(panel_8_3, "cell 1 9 4 1,grow");
		panel_8_3.setLayout(new MigLayout("", "[30:30:30,grow][27,grow,fill][119.00][27,grow][97.00][20,grow,fill][84.00][24,grow,fill][63.00][186.00,grow,left]", "[14px]"));
		...
		JLabel lblNewLabel_31 = new JLabel("R$ 110,00");
		...
		panel_8_3.add(lblNewLabel_34, "flowx,cell 9 0,alignx left");

		JLabel lblNewLabel_35 = new JLabel("0");
		lblNewLabel_35.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		panel_8_3.add(lblNewLabel_35, "cell 9 0,alignx left");
		...
		panel_8_3.add(lblNewLabel_36, "cell 9 0,alignx left");

		JPanel panel_8_7 = new JPanel();
		Principal.add(panel_8_7, "cell 1 10 4 1,grow");
		panel_8_7.setLayout(new MigLayout("", "[30:30:30,grow][27,grow,fill][48.00][27,grow][97.00][20,grow,fill][84.00][24,grow,fill][63.00][186.00,grow,left]", "[14px]"));
		...
		panel_8_7.add(lblNewLabel_66, "flowx,cell 9 0,alignx left");

		JLabel lblNewLabel_67 = new JLabel("0");
		lblNewLabel_67.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		panel_8_7.add(lblNewLabel_67, "cell 9 0,alignx left");

		JLabel lblNewLabel_68 = new JLabel("");
		lblNewLabel_68.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblNewLabel_68.setIcon(new ImageIcon(TelaServicos.class.getResource("/visao/Add_square_light.png")));
		panel_8_7.add(lblNewLabel_68, "cell 9 0,alignx left");
		
		JPanel panel_8_9 = new JPanel();
		Principal.add(panel_8_9, "cell 1 11 4 1,grow");
		panel_8_9.setLayout(new MigLayout("", "[30:30:30,grow][27,grow,fill][60.00][27,grow][97.00][20,grow,fill][84.00][24,grow,fill][63.00][186.00,grow,left]", "[14px]"));
								...
								panel_8_9.add(lblNewLabel_79, "cell 3 0,alignx left,aligny center");
										...
										panel_8_9.add(lblNewLabel_80, "cell 5 0,alignx left,aligny center");
												...
												panel_8_9.add(lblNewLabel_81, "cell 7 0,alignx left,aligny center");
														...
														panel_8_9.add(lblNewLabel_82, "flowx,cell 9 0,alignx left");
														
																JLabel lblNewLabel_83 = new JLabel("0");
																lblNewLabel_83.setFont(new Font("Times New Roman", Font.PLAIN, 16));
																panel_8_9.add(lblNewLabel_83, "cell 9 0,alignx left");
																
																		JLabel lblNewLabel_84 = new JLabel("");
																		lblNewLabel_84.setFont(new Font("Tahoma", Font.PLAIN, 11));
																		lblNewLabel_84.setIcon(new ImageIcon(TelaServicos.class.getResource("/visao/Add_square_light.png")));
																		panel_8_9.add(lblNewLabel_84, "cell 9 0,alignx left");
																		
																		
																				JPanel panel_8_10 = new JPanel();
																				Principal.add(panel_8_10, "cell 1 12 4 1,grow");
																				panel_8_10.setLayout(new MigLayout("", "[30:30:30,grow][27,grow,fill][97.00][27,grow][97.00][20,grow,fill][84.00][24,grow,fill][63.00][186.00,grow,left]", "[14px]"));
																										...
																										panel_8_10.add(lblNewLabel_87, "cell 3 0,alignx left,aligny center");
																												...
																												panel_8_10.add(lblNewLabel_88, "cell 5 0,alignx left,aligny center");
																														...
																														panel_8_10.add(lblNewLabel_89, "cell 7 0,alignx left,aligny center");
																																...
																																panel_8_10.add(lblNewLabel_90, "flowx,cell 9 0,alignx left");
																																
																																		JLabel lblNewLabel_91 = new JLabel("0");
																																		lblNewLabel_91.setFont(new Font("Times New Roman", Font.PLAIN, 16));
																																		panel_8_10.add(lblNewLabel_91, "cell 9 0,alignx left");
																																		
																																				JLabel lblNewLabel_92 = new JLabel("");
																																				lblNewLabel_92.setFont(new Font("Tahoma", Font.PLAIN, 11));
																																				lblNewLabel_92.setIcon(new ImageIcon(TelaServicos.class.getResource("/visao/Add_square_light.png")));
																																				panel_8_10.add(lblNewLabel_92, "cell 9 0,alignx left");
