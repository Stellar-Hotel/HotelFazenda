...
//	}
	...
	public TelaServicos( ) {
		...
		lblNewLabel_19_1.setIcon(new ImageIcon(TelaServicos.class.getResource("/visao/Quartos.jpg")));
		...
		JLabel lblNewLabel_26 = new JLabel("Funcionários");
		...
		BarraLateral.add(lblNewLabel_26, "cell 0 7");
