...
public class RoundedBorder extends AbstractBorder {
	...
	public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
		...
		g.drawRoundRect(x, y, width - 1, height - 1, radius, radius); // Desenha um retângulo arredondado com as
																		// dimensões e raio especificados
	}

	// Método para obter as margens da borda
	@Override
	public Insets getBorderInsets(Component c) {
		// Retorna as margens da borda como um objeto Insets com todas as margens
		// definidas com o valor do raio
